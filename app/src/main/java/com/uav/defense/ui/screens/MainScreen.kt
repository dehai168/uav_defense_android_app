...
fun MainScreen(viewModel: MainViewModel) {
    ...
    BoxWithConstraints(Modifier.fillMaxSize().background(BackgroundDark)) {
        val normalPanelWidth = (maxWidth - 4.dp) / 2
        val normalPanelHeight = (maxHeight - 4.dp) / 2
        ...
        val videoModifier = if (activeFullscreenPanel == "video") {
            Modifier
                .fillMaxSize()
                .zIndex(1f)
        } else {
            Modifier
                ...
                .width(normalPanelWidth)
                .height(normalPanelHeight)
                .zIndex(if (activeFullscreenPanel == null) 1f else -1f)
        }
        ...
        VideoPanel(
            ...
            MockData.cameras,
            currentTime,
            onDoubleTap = { viewModel.setFullscreen(if (activeFullscreenPanel == "video") null else "video") },
